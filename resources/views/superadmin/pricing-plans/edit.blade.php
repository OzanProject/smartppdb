...
@section('header', 'Edit Paket: ' . $pricingPlan->name)
...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="card card-outline card-primary shadow-sm border-0" style="border-radius: 15px;">
            <form action="{{ route('superadmin.pricing-plans.update', $pricingPlan->id) }}" method="POST">
                @csrf
                @method('PATCH')
                <div class="card-header bg-transparent border-0 pt-4 px-4">
                    <h3 class="card-title font-weight-bold"><i class="fas fa-edit mr-2 text-primary"></i> Update Detail Paket</h3>
                </div>
                <div class="card-body px-4 pb-4">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" id="input-name" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $pricingPlan->name) }}" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="order_weight" class="form-control" value="{{ old('order_weight', $pricingPlan->order_weight) }}" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="input-price-display" name="price_display" class="form-control @error('price_display') is-invalid @enderror" value="{{ old('price_display', $pricingPlan->price_display) }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="price" class="form-control @error('price') is-invalid @enderror" value="{{ old('price', $pricingPlan->price) }}" required>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="billing_cycle" id="input-cycle" class="form-control" required>
                                    <option value="monthly" {{ old('billing_cycle', $pricingPlan->billing_cycle) == 'monthly' ? 'selected' : '' }}>Bulanan</option>
                                    <option value="yearly" {{ old('billing_cycle', $pricingPlan->billing_cycle) == 'yearly' ? 'selected' : '' }}>Tahunan</option>
                                    <option value="custom" {{ old('billing_cycle', $pricingPlan->billing_cycle) == 'custom' ? 'selected' : '' }}>Sekali Bayar</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="trial_days" class="form-control @error('trial_days') is-invalid @enderror" value="{{ old('trial_days', $pricingPlan->trial_days) }}" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Teks Tombol CTA <span class="text-danger">*</span></label>
                                <input type="text" id="input-cta" name="cta_text" class="form-control" value="{{ old('cta_text', $pricingPlan->cta_text) }}" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" id="input-desc" name="description" class="form-control" value="{{ old('description', $pricingPlan->description) }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Limit Pendaftar (Kuota) <span class="text-danger">*</span></label>
                                <input type="number" name="max_quota" class="form-control" value="{{ old('max_quota', $pricingPlan->max_quota) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="input-features" name="features" class="form-control @error('features') is-invalid @enderror" rows="6" required>{{ old('features', $pricingPlan->features) }}</textarea>
                    ...
                    @php
                        $allowedModules = $pricingPlan->allowed_modules ?? [];
                    @endphp
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="custom-control custom-checkbox">
                                    <input class="custom-control-input" type="checkbox" id="moduleMaster" name="allowed_modules[]" value="master_data" {{ in_array('master_data', $allowedModules) ? 'checked' : '' }}>
                                    <label for="moduleMaster" class="custom-control-label">Data Master</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="custom-control custom-checkbox">
                                    <input class="custom-control-input" type="checkbox" id="modulePendaftaran" name="allowed_modules[]" value="pendaftaran" {{ in_array('pendaftaran', $allowedModules) ? 'checked' : '' }}>
                                    <label for="modulePendaftaran" class="custom-control-label">Data Pendaftaran</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="custom-control custom-checkbox">
                                    <input class="custom-control-input" type="checkbox" id="modulePengaturan" name="allowed_modules[]" value="pengaturan" {{ in_array('pengaturan', $allowedModules) ? 'checked' : '' }}>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="cta_link" class="form-control" value="{{ old('cta_link', $pricingPlan->cta_link) }}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mt-4">
                                <div class="custom-control custom-checkbox">
                                    <input class="custom-control-input" type="checkbox" id="isPopular" name="is_popular" value="1" {{ old('is_popular', $pricingPlan->is_popular) ? 'checked' : '' }}>
