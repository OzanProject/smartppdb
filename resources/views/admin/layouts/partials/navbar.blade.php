<nav class="main-header navbar navbar-expand navbar-white navbar-light border-bottom-0 shadow-sm">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block">
      <a href="{{ route('school.landing', auth()->user()->school->slug ?? '') }}" target="_blank" class="nav-link text-muted">
        <i class="fas fa-external-link-alt mr-1"></i> Lihat Website Sekolah
      </a>
    </li>
  </ul>
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown user-menu">
      <a href="#" class="nav-link dropdown-toggle d-flex align-items-center" data-toggle="dropdown">
        ...
        @else
            <div class="user-image img-circle bg-gradient-primary d-flex align-items-center justify-content-center mr-2 shadow-sm text-white font-weight-bold" style="width: 32px; height: 32px; font-size: 0.8rem;">
      ...
      <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right border-0 shadow-lg" style="border-radius: 15px; overflow: hidden;">
        <li class="user-header bg-primary d-flex flex-column align-items-center justify-content-center py-4">
          @if(auth()->user()->avatar)
          ...
          @else
              <div class="img-circle bg-white d-flex align-items-center justify-content-center mb-2 shadow font-weight-bold text-primary" style="width: 60px; height: 60px; font-size: 1.5rem;">
                  {{ strtoupper(substr(auth()->user()->name, 0, 1)) }}
              </div>
          @endif
          ...
          <small class="opacity-75">Administrator Sekolah</small>
        </li>
        <!-- Menu Footer-->
        <li class="user-footer bg-light px-4 py-3 d-flex justify-content-between">
          ...
          <a href="#" class="btn btn-primary btn-sm rounded-pill shadow-sm px-3" 
