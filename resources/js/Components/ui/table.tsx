...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto text-sm">
    <table
      ref={ref}
      className={cn("w-full caption-bottom text-slate-900", className)}
      {...props}
    />
  </div>
))
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-left align-middle font-medium text-slate-500 uppercase tracking-tight text-xs [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
